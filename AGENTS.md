...
`belisoful/prado-meta`: Typed, autoloaded entity meta storage for PRADO: one implementation, one table per entity type.
...
```
src/TEntityMetaModule.php   the example bootstrap module (TPluginModule)
